...
export default function CompletedTasksPage() {
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      try {
        ...
        const completedTasks = tasksData.filter((task: any) => task.task_status === 'completed');
  ...
  const handleStatusChange = async (id: string, newStatus: string) => {
    try {
      ...
      // Remove task from list if status is changed from completed
    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="text-center py-8">
          ...
          <h3 className="text-lg font-medium mb-1">No completed tasks found</h3>
